...
public class BaseUtils {
	...
	/**
	 * Capture screenshot and store inside Extent report folder. Returns relative
	 * path for Extent report usage.
	 */
	public static String takeScreenshot(String testName) throws IOException {
		...
		String reportScreenshotDir = System.getProperty("user.dir") + "/test-output/extent-reports/screenshots/";
		...
		String fullPath = reportScreenshotDir + fileName;
	...
	public static void captureElementScreenshot(WebElement element, String elementName) throws IOException {
		...
		String dir = System.getProperty("user.dir") + "/test-output/extent-reports/screenshots/elements/";

		new File(dir).mkdirs();

		String fileName = elementName.replaceAll("\\s+", "_") + "_" + System.currentTimeMillis() + ".png";
