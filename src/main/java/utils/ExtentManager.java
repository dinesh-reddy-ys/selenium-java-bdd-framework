...
public class ExtentManager {
	// Static instance of ExtentReports to ensure a single instance is used
	// throughout the application
	private static ExtentReports extent;

	/**
	 * Returns the singleton instance of ExtentReports. If the instance is null, it
	 * initializes the ExtentReports object with the required configuration.
	 *
